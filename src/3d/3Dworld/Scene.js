                            ...
                            if (solution.tasks && Array.isArray(solution.tasks)) {
                                ...
                                for (let taskIndex = 0; taskIndex < solution.tasks.length; taskIndex++) {
                                    if (taskIndex < 5) {
                                        ...
                                        challenge1Tasks[solutionIndex].push(
                                            <TaskComponent
                                                key={`Task${1}${solutionIndex + 1}${taskIndex + 1}`}
                                                rotate={0}
                                                onClick={
                                                    () => handleTaskIndexer(challengeIndex, solutionIndex, taskIndex)
                                                    // console.log(challengeIndex, solutionIndex, taskIndex)
                                                }
                            ...
                            if (solution.tasks && Array.isArray(solution.tasks)) {
                                ...
                                for (let taskIndex = 0; taskIndex < solution.tasks.length; taskIndex++) {
                                    if (taskIndex < 5) {
                                        ...
                                        challenge2Tasks[solutionIndex].push(
                                            <>
                                                <TaskComponent
                                                    key={`Task${1}${solutionIndex + 1}${taskIndex + 1}`}
                                                    rotate={Math.PI}
    ...
    return (
        <>
            ...
            {Object.keys(subsubTasks).map(
              (solutionIndex) => subsubTasks[solutionIndex]
            )}
          </group> */}
