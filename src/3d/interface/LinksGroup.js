...
export function LinksGroup({ icon: Icon, label, initiallyOpened, links, index, tasks, subtasks }) {
    ...
    const handleSolution = (index) => {
        setDialogState('solution');
        setOpened2(true);
    ...
    // const handleLabelClick = (event, topicIndex, solutionIndex) => {
    //   event.preventDefault();
    //   setOpened3(true);
    //   // console.log(links);

    //   setControlTopic(topicIndex);
    //   setControlSolution(solutionIndex);
    //   // console.log(topicIndex, solutionIndex);
    //   // console.log(mockData[topicIndex].links[solutionIndex].tasks);
    // };
